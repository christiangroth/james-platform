...
import de.chrgroth.james.platform.domain.port.`in`.catalog.CatalogPort
import de.chrgroth.james.platform.domain.port.`in`.playback.PlaybackAggregationPort
import de.chrgroth.james.platform.domain.port.`in`.playback.PlaybackPort
import de.chrgroth.james.platform.domain.port.`in`.playlist.PlaylistPort
...
class DomainOutboxContractTests {
  ...
  fun `every DomainOutboxEvent type has a handler method in one of the domain ports`() {
    val allPortMethods = listOf(PlaybackPort::class, PlaybackAggregationPort::class, CatalogPort::class, PlaylistPort::class)
