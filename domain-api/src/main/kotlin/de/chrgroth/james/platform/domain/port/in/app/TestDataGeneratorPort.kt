...
/** Result of [TestDataGeneratorPort.generateTestData]. */
...
/**
 * Automatic test data generator. Generates and persists valid test objects for an Entity into a Developer's test installation, deriving
 * values from each Property's [de.chrgroth.james.platform.domain.model.app.PropertyType] and
 * [de.chrgroth.james.platform.domain.model.app.PropertyConstraint]s. `REF` properties without any existing target objects
