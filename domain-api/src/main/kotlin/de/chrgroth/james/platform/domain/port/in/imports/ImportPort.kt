...
interface ImportPort {
  ...
  fun deleteImportJob(userId: String, installedAppId: String, importJobId: String): Either<DomainError, Unit>
  fun selectDataPath(userId: String, installedAppId: String, importJobId: String, dataPath: String): Either<DomainError, ImportJob>
  fun getMappingView(userId: String, installedAppId: String, importJobId: String): Either<DomainError, MappingView>
  fun updateMapping(
    userId: String,
  ...
  fun dryRun(userId: String, installedAppId: String, importJobId: String): Either<DomainError, DryRunReport>
  ...
  fun acceptDryRun(userId: String, installedAppId: String, importJobId: String): Either<DomainError, DryRunAcceptResult>
}
