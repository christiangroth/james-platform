...
interface ImportConnectionPort {
  ...
  fun createConnection(userId: String, name: String, baseUrl: String, bearerToken: String?): Either<DomainError, ImportConnection>
  ...
  /** Performs a real request against the connection's base URL using its stored credentials, without persisting anything. */
