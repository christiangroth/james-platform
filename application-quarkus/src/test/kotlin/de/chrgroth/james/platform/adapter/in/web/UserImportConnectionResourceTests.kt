...
class UserImportConnectionResourceTests {
  ...
  fun `connections page is forbidden for users without DATA_IMPORT role`() {
    given()
      .`when`()
      .get("/ui/user/import-connections")
      .then()
      .statusCode(403)
  }
  ...
  fun `creating a connection is forbidden for users without DATA_IMPORT role`() {
    given()
      ...
      .formParam("url", "https://example.com/data")
      .`when`()
      .post("/ui/user/import-connections")
      .then()
      .statusCode(403)
  ...
  fun `updating a connection replaces its name and url`() {
    ...
    given()
      ...
      .formParam("url", "https://example.com/v2")
      .`when`()
      .post("/ui/user/import-connections/$connectionId")
      .then()
      .statusCode(200)
      .body("ok", equalTo(true))
  ...
  fun `updating an unknown connection reports an error`() {
    given()
      ...
      .formParam("url", "https://example.com/data")
      .`when`()
      .post("/ui/user/import-connections/unknown-connection")
      .then()
      .statusCode(200)
      .body("ok", equalTo(false))
  }
  ...
  fun `deleting a connection removes it from the table`() {
    ...
    given()
      .`when`()
      .post("/ui/user/import-connections/$connectionId/delete")
      .then()
      .statusCode(200)
      .body("ok", equalTo(true))
  ...
  fun `deleting an unknown connection reports an error`() {
    given()
      .`when`()
      .post("/ui/user/import-connections/unknown-connection/delete")
      .then()
      .statusCode(200)
      .body("ok", equalTo(false))
  }
  ...
  fun `testing a connection performs a real fetch and reports success`() {
    ...
    given()
      .`when`()
      .post("/ui/user/import-connections/$connectionId/test")
      .then()
      .statusCode(200)
      .body("ok", equalTo(true))
  }
  ...
  fun `testing an unknown connection reports an error`() {
    given()
      .`when`()
      .post("/ui/user/import-connections/unknown-connection/test")
      .then()
      .statusCode(200)
      .body("ok", equalTo(false))
  }
