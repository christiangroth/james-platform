...
class UserImportResourceTests {
  ...
  fun `delete import job removes it from the table`() {
    ...
    given()
      .`when`()
      .post("/ui/user/imports/$installedAppId/$importId/delete")
      .then()
      .statusCode(200)
      .body("ok", equalTo(true))
  ...
  fun `delete import job reports an error for an unknown job id`() {
    ...
    given()
      .`when`()
      .post("/ui/user/imports/$installedAppId/unknown-id/delete")
      .then()
      .statusCode(200)
      .body("ok", equalTo(false))
  }
  ...
  fun `select data path reports an error for a path that is not an array of objects`() {
    ...
    given()
      ...
      .`when`()
      .post("/ui/user/imports/$installedAppId/$importId/select-path")
      .then()
      .statusCode(200)
      .body("ok", equalTo(false))
  }
  ...
  fun `select data path reports an error for an unknown job id`() {
    ...
    given()
      ...
      .`when`()
      .post("/ui/user/imports/$installedAppId/unknown-id/select-path")
      .then()
      .statusCode(200)
      .body("ok", equalTo(false))
  }
  ...
  fun `mapping page renders the fixed target entity's properties`() {
    ...
    val html = given()
      .`when`()
      .get("/ui/user/imports/${app.installedAppId}/$importId/mapping")
      .then()
      .statusCode(200)
      .extract().body().asString()
  ...
  fun `saving a complete and valid mapping transitions the import job to READY`() {
    ...
    given()
      ...
      .`when`()
      .post("/ui/user/imports/${app.installedAppId}/$importId/mapping")
      .then()
      .statusCode(200)
      .body("ok", equalTo(true))
  ...
  fun `dry run page reports one valid and one invalid object with the missing mandatory value highlighted`() {
    ...
    val html = given()
      .`when`()
      .get("/ui/user/imports/${app.installedAppId}/$importId/dry-run")
      .then()
      .statusCode(200)
      .extract().body().asString()
  ...
  fun `accepting a dry run saves the valid object, discards the invalid one and deletes the import job`() {
    ...
    given()
      .`when`()
      .post("/ui/user/imports/${app.installedAppId}/$importId/dry-run/accept")
      .then()
      .statusCode(200)
      .body("ok", equalTo(true))
  ...
  fun `reference lookup resolves a mapped REF property to the id of the matching referenced entity`() {
    ...
    given()
      ...
      .`when`()
      .post("/ui/user/imports/$installedAppId/$importId/mapping")
      .then()
      .statusCode(200)
      .body("ok", equalTo(true))
    ...
    val mappingHtml = given()
      .`when`()
      .get("/ui/user/imports/$installedAppId/$importId/mapping")
      .then()
      .statusCode(200)
      .extract().body().asString()
    ...
    given()
      .`when`()
      .post("/ui/user/imports/$installedAppId/$importId/dry-run/accept")
      .then()
      .statusCode(200)
      .body("ok", equalTo(true))
  ...
  fun `directly mapped REF property pointing to a non-existing instance is reported invalid and discarded on accept`() {
    ...
    val dryRunHtml = given()
      .`when`()
      .get("/ui/user/imports/$installedAppId/$importId/dry-run")
      .then()
      .statusCode(200)
      .extract().body().asString()
