...
In the second example, if multiple validations fail (e.g., both username and email are invalid), all errors will be collected in the `NonEmptyList` and returned together, rather than failing fast after the first error.
