...
class KtorKMongoServiceTests {
    ...
    fun `generateModels creates expected source files`() {
        ...
        assertThat(modelsFile.readText()).isEqualTo("Models.kt.expected".asExpectedContent())
    }
    ...
    fun `generateControllers creates expected source files`() {
        ...
        assertThat(modelsFile.readText()).isEqualTo("Controllers.kt.expected".asExpectedContent())
    }
    ...
    fun `generatePersistence creates expected source files`() {
        ...
        assertThat(modelsFile.readText()).isEqualTo("Persistence.kt.expected".asExpectedContent())
    }
    ...
    fun `generateApplication creates expected source files`() {
        ...
        assertThat(modelsFile.readText()).isEqualTo("Application.kt.expected".asExpectedContent())
    }
    ...
    private fun String.asExpectedContent() = File("src/test/resources/codeGeneration/$this").readText()
}