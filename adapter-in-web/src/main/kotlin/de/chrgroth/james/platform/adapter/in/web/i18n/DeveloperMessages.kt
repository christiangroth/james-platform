...
interface DeveloperMessages {
  ...
  @Message
  fun developerAppStatusInactiveLabel(): String

  @Message
  fun developerDeactivateAppModalTitle(): String
  ...
  @Message
  fun developerAppDeactivatedMessage(activeInstallationCount: Int): String
