...
data class App private constructor(
    ...
    companion object {
        ...
        ): ValidatedNel<de.chrgroth.james.Error, App> =
    ...
    internal fun addNextVersionDraftDatatype(datatypeName: String): ValidatedNel<de.chrgroth.james.Error, App> = when {
    ...
    internal fun changeNextVersionDraftDatatype(
        ...
        description: String?,
        newName: String,
    ): ValidatedNel<de.chrgroth.james.Error, App> = when {
        !status.allowsChanges -> Validated.invalidNel(
            de.chrgroth.james.Error(
    ...
    internal fun addNextVersionDraftReport(reportName: String): ValidatedNel<de.chrgroth.james.Error, App> = when {
        !status.allowsChanges -> Validated.invalidNel(
            de.chrgroth.james.Error(
                code = AppErrorCodes.DISCONTINUED_NO_CHANGES_ALLOWED,
                details = null,
    ...
    private fun createNextVersionDraft(latestVersion: AppVersion): ValidatedNel<de.chrgroth.james.Error, AppVersionDraft> =
        latestVersion.let {
            ...
            return when {
                datatypeConversionErrors != null -> datatypeConversionErrors as ValidatedNel<de.chrgroth.james.Error, AppVersionDraft>
                else -> {
    ...
    internal fun changeReleaseNote(version: Semver, note: String): ValidatedNel<de.chrgroth.james.Error, App> = when {
    ...
    internal fun discontinue(): ValidatedNel<de.chrgroth.james.Error, App> = when {
        !status.allowsChanges -> Validated.invalidNel(
            de.chrgroth.james.Error(
                code = AppErrorCodes.DISCONTINUED_NO_CHANGES_ALLOWED,
                details = null,
    ...
    internal fun verifyDeletion(): ValidatedNel<de.chrgroth.james.Error, Unit> = when {
...
data class AppVersion private constructor(
    ...
    companion object {
        ...
        ): ValidatedNel<de.chrgroth.james.Error, AppVersion> =
        ...
        private fun create(base: AppVersion, note: String): ValidatedNel<de.chrgroth.james.Error, AppVersion> =
    ...
    internal fun changeReleaseNote(note: String): ValidatedNel<de.chrgroth.james.Error, AppVersion> = create(this, note)
}
...
data class AppVersionDraft private constructor(
    ...
    companion object {
        ...
        @Suppress("UNCHECKED_CAST")
        fun create(appVersion: AppVersion): ValidatedNel<de.chrgroth.james.Error, AppVersionDraft> {
            ...
            return when {
                conversionErrors != null -> conversionErrors as ValidatedNel<de.chrgroth.james.Error, AppVersionDraft>
                else -> create(datatypes = convertedDatatypes.collectResults<AppDatatypeDraft>().map { it.value }.toSet(), reports = appVersion.reports)
            }
        }

        fun create(datatypes: Set<AppDatatypeDraft>, reports: Set<AppReport>): ValidatedNel<de.chrgroth.james.Error, AppVersionDraft> =
            Validated.validNel(AppVersionDraft(datatypes = datatypes, reports = reports))
    }

    internal fun createDatatypes(latest: AppVersion?): ValidatedNel<de.chrgroth.james.Error, Set<AppDatatype>> {
    ...
    internal fun upsertDatatype(name: String, datatype: AppDatatypeDraft): ValidatedNel<de.chrgroth.james.Error, AppVersionDraft> =
        datatype.validateJsonSchema().andThen {
            create(datatypes.upsert(name, datatype), reports)
        }

    internal fun removeDatatype(datatypeName: String): ValidatedNel<de.chrgroth.james.Error, AppVersionDraft> = when {
    ...
    internal fun upsertReport(name: String, report: AppReport): ValidatedNel<de.chrgroth.james.Error, AppVersionDraft> =
        create(datatypes, reports.upsert(name, report))

    internal fun removeReport(reportName: String): ValidatedNel<de.chrgroth.james.Error, AppVersionDraft> = when {
...
data class AppVersionReleaseNotes private constructor(
    ...
    companion object {
        ...
        fun create(changeType: AppVersionChangeType, note: String): ValidatedNel<de.chrgroth.james.Error, AppVersionReleaseNotes> =
...
data class AppDatatypeDraft private constructor(
    ...
    companion object {
        ...
        fun create(datatype: AppDatatype): ValidatedNel<de.chrgroth.james.Error, AppDatatypeDraft> = create(
            name = datatype.name,
            schemaContent = datatype.schemaContent,
            description = datatype.description,
        )

        fun create(name: String, schemaContent: String, description: String?): ValidatedNel<de.chrgroth.james.Error, AppDatatypeDraft> =
            nameParser.parse(name).map { validName ->
                AppDatatypeDraft(
                    nameField = validName,
    ...
    fun validateJsonSchema(): ValidatedNel<de.chrgroth.james.Error, ObjectSchema> = jsonObjectSchemaFor(
        // TODO #19 appId = appId,
...
data class AppDatatype private constructor(
    ...
    companion object {
        ...
        fun create(draft: AppDatatypeDraft, version: Long): ValidatedNel<de.chrgroth.james.Error, AppDatatype> {

            // TODO #29 any way to not create a new instance every time?
            val datatypeParser: Parser<AppDatatypeParserInput, AppDatatype, de.chrgroth.james.Error> = Parser
                .compose(
...
data class AppReport private constructor(
    ...
    companion object {
        ...
        fun create(name: String, description: String?, source: String): ValidatedNel<de.chrgroth.james.Error, AppReport> =
            nameParser.parse(name).map { validName ->
                AppReport(
                    nameField = validName,
                    sourceField = source,
