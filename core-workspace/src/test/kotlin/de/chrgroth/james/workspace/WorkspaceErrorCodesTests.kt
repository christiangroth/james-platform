...
class WorkspaceErrorCodesTests {
    ...
    fun ensureErrorCodesNotChanged() {
        ...
        assertThat(INSTALLATION_NOT_FOUND.toGlobalRepresentation()).isEqualTo("WORKSPACE_004_INSTALLATION_NOT_FOUND")
        assertThat(DOWNGRADE_NOT_SUPPORTED.toGlobalRepresentation()).isEqualTo("WORKSPACE_005_DOWNGRADE_NOT_SUPPORTED")
        ...
        assertThat(UNINSTALL_NOT_SUPPORTED.toGlobalRepresentation()).isEqualTo("WORKSPACE_007_UNINSTALL_NOT_SUPPORTED")
