...
class ImportScheduleServiceTests {
  ...
  private val service = ImportScheduleService(importDefinitionRepository, importPort)

  private fun definition(id: String, schedule: String?, lastRunAt: Instant?, createdAt: Instant = Instant.now().minusSeconds(86_400)) = ImportDefinition(
