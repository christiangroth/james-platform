...
@ApplicationScoped
@Suppress("Unused")
class AppDataLastValidatedWithVersionMigrationStarter(
  private val appDataMigration: AppDataMigrationPort,
) : Starter {

  override val id = "AppDataLastValidatedWithVersionMigrationStarter-v1"

  override fun execute() {
    appDataMigration.backfillLastValidatedWithVersion()
  }
}
