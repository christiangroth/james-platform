...
- **Aggregations** – Developers declare precomputed rollups (SUM/COUNT/AVG/MIN/MAX, optional day/week/month/year bucketing, optional grouping via a `ref` or another
  property) over an Entity's data in the version editor. Ungrouped values are shown directly on the app installation; grouped and/or time-bucketed ones as a compact,
  capped table.
